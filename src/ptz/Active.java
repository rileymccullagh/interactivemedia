...
class Active {
	...
	Active(PApplet p) {
		...
		this.bigBall = new TextureSphere(this.parent);
	...
	void draw() {
		// cam.cancel_threads(); //Later we can implement this, so we can prevent it
		// retrieving during render
		parent.clear();
		fft.update();
